<div class=".container_icons_new">
    ...
    <div class="social_icons_news">
        ...
        <!-- <a href="https://www.facebook.com/profile.php?id=61553333167475" target="_blank"><img src="assets/images/facebook.png" alt="facebook"></a> -->
...
<!--     
    <footer style="margin-top: 100px; height: 460px" class="bg-dark text-light">
        <div class="container">
            <div class="f-items default-padding">
                <div class="row RogerRow">
                    <div class="col-lg-12 col-md-6 item RogerFooter">
                        <div class="f-item about">
                            <h2>INTEREST SERVICES</h2>
                            <img src="img/icons/logoE.png" alt="Logo">
                            <p>
                                Evangelinas Cleaning Services
                            </p>
                            <a class="btn circle btn-theme border btn-md" href="https://www.avangelinascleaningservices.com/">More About</a>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <footer style="margin: -35px 0px 0px 0px;" >
                            ...
                            <div id="text-11" class="widget widget_text bigslam-widget">
                                ...
                                <div class="textwidget">
                                    ...
                                    <p>We are an organization dedicated to promoting and fostering high school soccer in
                                        the beautiful region of Gatlinburg-Pigeon Forge, Tennessee. <br>
                                </div>
                            </div>
                        </div>
                        <div class="bigslam-footer-column bigslam-item-pdlr bigslam-column-20">
                ...
                <div class="bigslam-copyright-wrapper">
                    <div class="bigslam-copyright-container bigslam-container">
                        <div class="bigslam-copyright-text bigslam-item-pdlr">Copyright 2024 Smoky Mountain Cup
                            Tennessee, All Right
                            Reserved</div>
                    </div>
                </div>
