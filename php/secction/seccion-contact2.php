...
<div class="gdlr-core-pbf-wrapper " style="padding: 70px 0px 35px 0px; " data-skin="White Text">
                                    ...
                                    <div style=" padding: 70px 60px 35px 0px;"
                                        ...
                                        <div class="gdlr-core-call-to-action-item-inner">
                                            <div class="gdlr-core-call-to-action-item-content-wrap">
                                                <h3 class="gdlr-core-call-to-action-item-title"
                                                    style="font-size: 39px ;letter-spacing: 0px ;">Do you want to sell
                                                    at the tournament?</h3>
                                                <div class="gdlr-core-call-to-action-item-caption gdlr-core-title-font gdlr-core-skin-caption"
                                                    style="font-size: 17px ;">Send us your information to become part of
                                                    it.</div>

                                            </div>

                                            <div class="gdlr-core-pbf-wrapper " style="padding: 95px 0px 90px 0px;"
                                                data-skin="Grey">
                                                <div class="gdlr-core-pbf-background-wrap"
                                                    style="background-color: #2d27272b ;"></div>
                                                                    ...
                                                                    <div class="gdlr-core-pbf-element">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                style="font-size: 19px ;font-style: normal ;">and
                                                                        ...
                                                                        <div class="gdlr-core-divider-item gdlr-core-divider-item-normal gdlr-core-item-pdlr gdlr-core-center-align"
                                                                            ...
                                                                            <div class="gdlr-core-divider-container"
                                                                                ...
                                                                                <div class="gdlr-core-divider-line gdlr-core-skin-divider"
                                                                                    style="border-color: #2b2b2b ;border-width: 2px;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="gdlr-core-pbf-element">
                                                                        <div
                                                                            ...
                                                                            <div role="form" class="wpcf7"
                                                                                id="wpcf7-f1319-p1964-o1" lang="en-US"
                                                                                dir="ltr">
                                                                                ...
                                                                                <form class="quform"
                                                                                    ...
                                                                                    <div class="quform-elements">
                                                                                        ...
                                                                                        <div class="quform-submit">
                                                                                            <div
                                                                                                class="quform-submit-inner">
                                                                                                <button type="submit"
                                                                                                    class="submit-button"><span>Send</span></button>
                                                                                            </div>
                                                                                            <div
                                                                                                class="quform-loading-wrap">
                                                                                                <span
                                                                                                    class="quform-loading"></span>
                                                                                            </div>
                                                                                        </div>
                                                                                        </p>
                                                                                    </div>
