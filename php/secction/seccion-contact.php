<div class="gdlr-core-pbf-wrapper " style="padding: 0px 0px 35px 0px; " data-skin="White Text">
    <div class="gdlr-core-pbf-background-wrap" style="background-color: #e6e6e6 ;"></div>
                    ...
                    <div class="gdlr-core-call-to-action-item-inner">
                        <div class="gdlr-core-call-to-action-item-content-wrap">
                            <h3 class="gdlr-core-call-to-action-item-title"
                                style="font-size: 37px ;letter-spacing: 0px ;">
                                Join the exciting Smokey Mountain Cup tournament!</h3>
                            <div class="gdlr-core-call-to-action-item-caption gdlr-core-title-font gdlr-core-skin-caption"
                                style="font-size: 17px ;">Get ready for the ultimate competition!
                                ...
                                camaraderie, and top-notch soccer.</div>
                        </div>

                        <div class="gdlr-core-pbf-wrapper " style="padding: 95px 0px 90px 0px;" data-skin="Grey">
                            <div class="gdlr-core-pbf-background-wrap" style="background-color: #2d27272b ;"></div>
                            <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
